#!/usr/bin/env bash
# Phase 12 — runs the control-flow embedding fuzz cases generated
# by `gen_ctrl_flow.py`. Sibling of run_nested.sh; same per-language
...
CASES_DIR=$SCRIPT_DIR/cases_ctrl_flow
OUT_DIR=$SCRIPT_DIR/out_ctrl_flow
...
${body}
    Expected = ${expected_n},
    case Ret of
        Expected -> io:format("PASS: ctrl-flow~n");
        Other ->
