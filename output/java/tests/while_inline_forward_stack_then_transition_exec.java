...
class S {
    ...
    public S() {
        ...
        __compartment = new SCompartment("P");
...
class Main {
    public static void main(String[] args) {
        ...
        try {
            S s = new S();
            s.e();
            System.out.println("ok 1 - while_inline_forward_stack_then_transition_exec");
        } catch (Exception ex) {
            System.out.println("not ok 1 - while_inline_forward_stack_then_transition_exec # " + ex);
        }
    }
}
