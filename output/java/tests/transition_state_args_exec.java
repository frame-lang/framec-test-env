...
class S {
    ...
    private void _state_A(SFrameEvent __e) {
        if (__e._message.equals("e")) {
            ...
            __compartment.state_args.put("0", 1);
            __compartment.state_args.put("1", 2);
            __compartment.state_args.put("2", 3);
...
class Main {
    public static void main(String[] args) {
        ...
        try {
            S s = new S();
            s.e();
            System.out.println("ok 1 - transition_state_args_exec");
        } catch (Exception ex) {
            System.out.println("not ok 1 - transition_state_args_exec # " + ex);
        }
    }
}
