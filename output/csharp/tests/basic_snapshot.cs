...
class Stubs {
    public static void native_stub() {}
}
...
class S {
    ...
    public void e(object x, object y, object z) {
    ...
    private void _state_A(SFrameEvent __e) {
        if (__e._message == "e") {
            ...
            var y = (object) __e._parameters["y"];
            var z = (object) __e._parameters["z"];
            Stubs.native_stub();
        }
    }
}
...
class Program {
    static void Main(string[] args) {
        ...
        try {
            S s = new S();
            s.e("a", "b", "c");
            Console.WriteLine("ok 1 - basic_snapshot");
        } catch (Exception ex) {
            Console.WriteLine("not ok 1 - basic_snapshot # " + ex);
        }
    }
}
