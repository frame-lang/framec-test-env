...
private:
    ...
    void _state_A(SFrameEvent& __e) {
        if (__e._message == "e") {
            ...
            _state_stack.push_back(__compartment->clone());; y = 2;  // inline native after stack push
