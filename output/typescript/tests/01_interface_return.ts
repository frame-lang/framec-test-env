...
class InterfaceReturnFrameContext {
    public event: InterfaceReturnFrameEvent;
    public _return: any;
    public _data: Record<string, any>;

    constructor(event: InterfaceReturnFrameEvent, default_return: any) {
        this.event = event;
...
class InterfaceReturnCompartment {
    ...
    public parent_compartment: InterfaceReturnCompartment | null;

    constructor(state: string, parent_compartment: InterfaceReturnCompartment | null = null) {
        this.state = state;
        this.state_args = {  };
        this.state_vars = {  };
        this.enter_args = {  };
    ...
    public copy(): InterfaceReturnCompartment {
...
class InterfaceReturn {
    ...
    private __compartment: InterfaceReturnCompartment;
    private __next_compartment: InterfaceReturnCompartment | null;
    ...
    private __kernel(__e: InterfaceReturnFrameEvent) {
    ...
    private __router(__e: InterfaceReturnFrameEvent) {
    ...
    private __transition(next_compartment: InterfaceReturnCompartment) {
        this.__next_compartment = next_compartment;
    }

    public bool_return(): boolean {
    ...
    public conditional_return(x: number): string {
    ...
    public computed_return(a: number, b: number): number {
    ...
    public explicit_conditional(x: number): string {
    ...
    public explicit_computed(a: number, b: number): number {
    ...
    private _state_Active(__e: InterfaceReturnFrameEvent) {
