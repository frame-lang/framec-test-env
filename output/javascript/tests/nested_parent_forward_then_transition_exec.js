...
function main() {
    ...
    try {
        ...
        console.log("ok 1 - nested_parent_forward_then_transition_exec");
    } catch (ex) {
        console.log(`not ok 1 - nested_parent_forward_then_transition_exec # ${ex}`);
    }
}
main();
