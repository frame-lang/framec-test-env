...
export class TransitionExitArgsFrameEvent {
    _message;
    _parameters;
...
export class TransitionExitArgsFrameContext {
    event;
    _return;
    _data;
...
export class TransitionExitArgsCompartment {
    state;
    state_args;
    state_vars;
    enter_args;
...
export class TransitionExitArgs {
    _state_stack;
    __compartment;
    __next_compartment;
    _context_stack;
    ...
    leave() {
        ...
        const __ctx = new TransitionExitArgsFrameContext(__e, null);
