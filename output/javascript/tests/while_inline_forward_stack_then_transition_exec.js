...
export class S {
    ...
    constructor() {
        this._state_stack = [];
        this._context_stack = [];
        this.__compartment = new SCompartment("P");
...
function main() {
    ...
    try {
        ...
        console.log("ok 1 - while_inline_forward_stack_then_transition_exec");
    } catch (ex) {
        console.log(`not ok 1 - while_inline_forward_stack_then_transition_exec # ${ex}`);
    }
}
main();
