...
- framec binary: `../frame_transpiler/target/release/framec` (or full path used for this bug)
- Generated artifacts: `[path/to/generated.ts or .py, adapter harness scripts, container image tag, etc.]`
...
## Verification Tests
- Shared-env smoke / spec tests that now cover this behavior:
  - `[e.g. adapter_protocol/scripts/run_adapter_smoke.sh]`
  - `[add any additional tests under adapter_protocol/tests/...]`
